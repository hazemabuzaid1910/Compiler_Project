...
public class AngularLexer extends Lexer {
	...
	public static final int
		...
		NullishCoalescingAssign=80, ARROW=81, ReactCreatElement=82, Break=83, 
		Do=84, Instanceof=85, Typeof=86, Case=87, Else=88, ElseIf=89, New=90, 
		Var=91, Let=92, Catch=93, Finally=94, Return=95, Void=96, Continue=97, 
		For=98, Switch=99, While=100, Debugger=101, Function_=102, This=103, With=104, 
		Default=105, If=106, Throw=107, Delete=108, In=109, Try=110, As=111, From=112, 
		Of=113, NullLiteral=114, BooleanLiteral=115, StringLiteral=116, Enum=117, 
		Extends=118, Super=119, Const=120, Import=121, Implements=122, StrictLet=123, 
		Private=124, Public=125, Interface=126, Package=127, Protected=128, Static=129, 
		Map=130, UseRef=131, UseState=132, UseEffect=133, DecimalLiteral=134, 
		Identifier=135, TagName=136, ID=137, Number=138, WS=139, NgIfDirective=140, 
		NgForDirective=141, NgModule=142, Injectable=143, Pipe=144, OPEN_MUSTACHE=145, 
		CLOSE_MUSTACHE=146, CLOSE_TAG=147;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"MultiLineComment", "SingleLineComment", "At", "BACKTICK", "Class", "Export", 
			"Component", "Selector", "Standalone", "Imports", "Template", "Styles", 
			"Margin", "Margin_top", "Padding", "Display", "Color", "Border_color", 
			...
			"BooleanLiteral", "StringLiteral", "Enum", "Extends", "Super", "Const", 
			"Import", "Implements", "StrictLet", "Private", "Public", "Interface", 
			"Package", "Protected", "Static", "Map", "UseRef", "UseState", "UseEffect", 
			"DecimalLiteral", "Identifier", "TagName", "ID", "Number", "WS", "ESC", 
			"UNICODE_ESCAPE", "HEX_DIGIT", "AttributeChar", "TagNameStartChar", "TagNameChar", 
			"Digit", "AttributeChars", "HexChars", "DecChars", "SingleQuoteString", 
			...
			"Lowercase", "NgIfDirective", "NgForDirective", "NgModule", "Injectable", 
			"Pipe", "OPEN_MUSTACHE", "CLOSE_MUSTACHE", "CLOSE_TAG"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"NgForDirective", "NgModule", "Injectable", "Pipe", "OPEN_MUSTACHE", 
			"CLOSE_MUSTACHE", "CLOSE_TAG"
		};
	}
